		...
		<view class="mode">
			...
			<view class="info">
				<view class="infomation">
					...
					<view class="group4">
						...
						<input lines="1" class="phoneinput" v-model="phone" type="number" maxlength="11" placeholder="请输入电话" placeholder-style="color:#C1C2C3;" />
					</view>
					<view class="xiantiao"><view class="outer1"></view></view>
					<view class="group7">
						<text lines="1" class="txt3">身份证号：</text>
						<input lines="1" class="txt4" v-model="card" type="text" maxlength="18" placeholder="请输入身份证号码" placeholder-style="color:#C1C2C3;" />
					</view>
					<view class="xiantiao"><view class="outer1"></view></view>
					<view class="intitem">
					...
					<view v-if="dian == 1">
						...
						<view class="group10">
							...
							<input lines="1" class="info1" v-model="unit" type="text" maxlength="11" placeholder="请输入归属公司" placeholder-style="color:#C1C2C3;" />
						</view>
					</view>
					<view class="xiantiao"><view class="outer1"></view></view>
				</view>
			...
			<view class="picture">
				<view class="image" v-if="dian == 1">
					...
					<image :src="photo1 == '' ? '../../static/images/renzhengpic.png' : photo1" mode="widthFix" @click="chooseImage(1)"></image>
				</view>
				<view class="image">
					<view class="word8">请上传身份证人像面</view>
					<image :src="photo2 == '' ? '../../static/images/idCardfront.png' : photo2" mode="widthFix" @click="chooseImage(2)"></image>
				</view>
				<view class="image">
					<view class="word8">请上传身份证国徽面</view>
					<image :src="photo3 == '' ? '../../static/images/idCard.png' : photo3" mode="widthFix" @click="chooseImage(3)"></image>
				</view>
				<view class="image">
					<view class="word8">请上传驾驶证照片主页</view>
					<image :src="photo4 == '' ? '../../static/images/renzhengpic.png' : photo4" mode="widthFix" @click="chooseImage(4)"></image>
				</view>
				<view class="image">
					<view class="word8">请上传驾驶证照片副页</view>
					<image :src="photo5 == '' ? '../../static/images/renzhengpic.png' : photo5" mode="widthFix" @click="chooseImage(5)"></image>
				</view>
			...
			<view class="box12">
				<view class="layer8" v-if="status == 0"><text lines="1" class="word15" @click="next()">下一步</text></view>
				<view class="layer8" v-if="status == 2"><text lines="1" class="word15" @click="updata()">更新司机信息</text></view>
				<view class="layer8" v-if="status == 1"><text lines="1" class="word15">审核中</text></view>
				<view class="layer8" v-if="status == -1"><text lines="1" class="word15" @click="updata()">被驳回,请重新上传</text></view>
			</view>
		</view>
		<takinfo></takinfo>
	</view>
