<template>
	<view>
		<view class="myhead">
			<view class="userifom">
				<view class="headimg" @click="sethead">
					<image :src="headimg" mode="widthFix" v-if="headimg"></image>
					<image :src="headpic" v-else></image>
				</view>
				<view class="username">
					<view class="level">
						<view class="name">{{ name }}</view>
						<view class="ask" v-if="user_level.name">
		...
		<view class="tuigaung">
			...
			<view class="zixun">
				<button class="yqbtn" open-type="share" @tap="erm()">
					...
					<view class="zixunitemview" style="margin-top: 22rpx;">邀请用户</view>
				</button>
				...
				<button class="yqbtn" @tap="guide()">
					<image src="../../static/icon/zqgl.png" class="zixunitemimage"></image>
					<view class="zixunitemview" style="margin-top: 22rpx;">赚钱攻略</view>
				</button>
			</view>
		</view>
		<view class="functionlist">
			...
			<view class="functionitem" @tap="go()">
				<view class="itemleft">
					<image src="../../static/icon/myicon4.png"></image>
					<view>我要发车</view>
					<image class="icon" src="../../static/icon/rightzd.png"></image>
			...
			<view class="functionitem" @tap="yqsj()">
				<view class="itemleft">
					<image src="../../static/icon/yqsj.png"></image>
					<view>邀请司机</view>
					<image class="icon" src="../../static/icon/rightzd.png"></image>
				</view>
			</view>
		...
		<!-- 邀请二维码 -->
		<view class="qrcode" @click="yqsj_g()" v-if="code2show">
			<image :src="code2" mode="aspectFit"></image>
...
<script>
	...
	export default {
		...
		onLoad() {},
		onShow() {
			this.sanz = uni.getStorageSync('userInfo').order_notice;
